"""
build_gold_all_ditails_with_table.py
...
Purpose:
    ...
    contained HTML file (gold_all_ditails_with_table.html) you can double-click to view
...
Run this manually with:  python build_gold_all_ditails_with_table.py
Then double-click gold_all_ditails_with_table.html (or open it in a browser) to view it.
"""
...
# sync with build_gold_asset_value_matching.py / compair_to_other_rate.html
...
<script>
  // Auto-refresh: unlike compair_to_other_rate.html, this page's rows are
